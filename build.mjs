...
function homePage() {
  ...
  const content = '<section class="hero"><img class="hero-image" src="assets/images/hero-seitenfunkeln-warm-v4.webp" alt="Warme Buchwelt mit Blumen, Kerzenlicht und einem offenen Buch voller goldener Funken">'
    ...
    + '<section class="book-proof-section"><div class="book-proof-inner"><figure class="book-proof-figure"><img src="assets/images/meine-buchprojekte-tisch-v2.webp" alt="Sieben eigene Buchprojekte von Nicole Feller liebevoll auf einem Holztisch angeordnet" loading="lazy"><figcaption>Eine Auswahl meiner eigenen Buchprojekte.</figcaption></figure>'
    ...
    + '<section class="course-band course-band-warm"><div class="course-image course-image-collage"><img src="assets/images/seitenfunkeln-serie/10-community-ohne-haende-v2.webp" alt="Drei liebevoll gestaltete Bücher stehen gemeinsam vor einem warmen, himbeerfarbenen Hintergrund" loading="lazy"></div>'
...
function resourcesPage() {
  const content = '<section class="freebie-hero"><div class="freebie-hero-inner"><div class="freebie-copy"><span class="eyebrow">Kostenloses Seitenfunkeln-Starterpaket</span>'
    ...
    + '<section class="course-bridge"><img src="assets/images/seitenfunkeln-serie/10-community-ohne-haende-v2.webp" alt="Drei liebevoll gestaltete Bücher stehen gemeinsam vor einem warmen, himbeerfarbenen Hintergrund" loading="lazy"><div><span class="eyebrow">Wenn du begleitet weitergehen möchtest</span><h2>Vom ersten Funken zum eigenen Buch.</h2>'
